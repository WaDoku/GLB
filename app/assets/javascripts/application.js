...
$(document).ready(function(){
  $("#hide_lemma_schreibungen").click(function(){
    $(".toggle_lemma_schreibungen_visibility").hide(400);
  });
});

$(document).ready(function(){
  $("#show_lemma_schreibungen").click(function(){
    $(".toggle_lemma_schreibungen_visibility").show(400);
  });
});

$(document).ready(function(){
  $("#hide_uebersetzung").click(function(){
    $(".toggle_uebersetzung_visibility").hide(400);
  });
});

$(document).ready(function(){
  $("#show_uebersetzung").click(function(){
    $(".toggle_uebersetzung_visibility").show(400);
  });
});
