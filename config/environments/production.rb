DGLB::Application.configure do
  ...
  # See everything in the log (default in Rails <=5 is :info starting with Rails 5 ir will be :debug)
  ...
  config.action_mailer.smtp_settings = { :address => "smtpserv.uni-tuebingen.de", :openssl_verify_mode => 'none'}
